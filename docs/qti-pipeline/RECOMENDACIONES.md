...
**Archivo**: `app/qti-pipeline-4steps/pipeline/apply_math_corrections_to_segmented.py`
...
**Documentación completa**: Ver `app/qti-pipeline-4steps/docs/LIMITACIONES-EXTEND-AI-Y-SOLUCIONES.md`
...
**Script creado**: `app/qti-pipeline-4steps/tools/pdf_question_extractor.py`
...
2. **Probar con una pregunta**:
   ```bash
   python app/qti-pipeline-4steps/tools/pdf_question_extractor.py \
...
- `app/qti-pipeline-4steps/pipeline/pdf_parser.py` - Paso 1 (integra MathCorrector)
- `app/qti-pipeline-4steps/pipeline/math_corrector.py` - Módulo de corrección automática
- `app/qti-pipeline-4steps/pipeline/segmenter.py` - Paso 2 (segmentación)
...
**Uso:**
```bash
python app/qti-pipeline-4steps/run.py \
    app/data/pruebas/procesadas/prueba-invierno-2026/segmented.json \
    --step generate \
    --output app/data/pruebas/procesadas/prueba-invierno-2026
```
