...
def process_single_question_pdf(
    ...
    if skip_if_exists and not is_lambda:
        ...
        if os.path.exists(xml_path):
            ...
            try:
                ...
                if validation_result.get("success", False):
                    ...
                    print("   ⏭️  Saltándose procesamiento (puedes desactivar con skip_if_exists=False)")
                    ...
                    print("⚠️  XML existente no válido, regenerando...")
            except Exception as e:
        ...
        if not os.path.exists(xml_path) and os.path.exists(processed_json_path):
            print("📖 Encontrado processed_content.json, intentando regenerar XML...")
            try:
                ...
                if api_key:
                    ...
                    if result.get("success"):
                        print("✅ XML regenerado exitosamente desde processed_content.json")
                ...
                print("   Continuando con procesamiento completo...")
    ...
    try:
        ...
        if validation_result["success"]:
            ...
            print("🔍 Verificando imágenes restauradas (debe convertir base64 → S3)...")
            ...
            if not is_lambda:
                ...
                if base64_matches:
                    ...
                    if failed_uploads:
                        ...
                        print("   💡 El XML se guardará. Puedes convertir a S3 después con migrate_base64_to_s3.py")
                    ...
                    if remaining_base64:
                        ...
                        print("   💡 Se guardará el XML con base64. Puedes convertirlo a S3 después manualmente.")
                    else:
                        print("   ✅ Validación: Todas las imágenes están en S3 (0 base64 restantes)")
            ...
            if final_base64_check:
                ...
                print("💡 El XML se guardará con base64. Puedes convertirlo a S3 después usando:")
                print(f"   python3 scripts/migrate_base64_to_s3.py --test-name {test_name or 'test-name'}")
            else:
                print("✅ Validación final: Todas las imágenes están en S3 (0 base64)")
                ...
                if final_base64_check and not is_lambda:
                    ...
                    if qti_xml:
                        ...
                        if remaining_base64 == 0:
                            print("   ✅ Conversión manual exitosa: todas las imágenes ahora están en S3")
                        else:
