...
def evaluate_question_detail(pdf_content: Dict[str, Any], openai_api_key: str, subject: str, grade_level: str) -> Dict[str, Any]:
    """
    ...
    function_spec = {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "qtiInteractionType": {"type": "string", "enum": ["choiceInteraction", "orderInteraction", "extendedTextInteraction"]},
                "mediaTypesPresent": {"type": "array", "items": {"type": "string"}},
                ...
                "standards": {
                    ...
                    "items": {
                        "type": "object",
                        "properties": {"standardSet": {"type": "string", "enum": standard_enum}, "standardCode": {"type": "string"}},
                ...
                "correctAnswerKey": {
                    ...
                    "properties": {
                        "obtentionMethod": {
                            ...
                            "description": ("If correct answer was directly marked as correct in the original image or was guessed by the LLM"),
                        },
                        "answer": {"type": "string"},
                    },
