...
def construct_image_area_including_labels(
    ...
    if top_boundary == margin:
        ...
        print(f"🔍 📐 No Q&A block found above image labels, using conservative boundary")
    ...
    print(f"🔍 ✅ CONSTRUCTED image area:")
...
def construct_image_area_from_gaps_flexible(
    ...
    print(f"🔍 ✅ CONSTRUCTED flexible gap image:")
...
def construct_image_bbox_from_gaps(
    ...
    if not valid_gaps:
        print(f"🧠 ⚠️ No gaps larger than 100px found")
        return None
