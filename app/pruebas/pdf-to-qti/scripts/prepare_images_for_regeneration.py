...
def upload_image_to_s3_direct(
    ...
    if not aws_access_key or not aws_secret_key:
        print(f"   ❌ Credenciales AWS no encontradas")
        return None
...
def prepare_images_for_question(
    ...
    print(f"📖 Cargando extracted_content.json...")
    ...
    if processed_content.get('image_base64') and processed_content['image_base64'].startswith('CONTENT_PLACEHOLDER_'):
        ...
        if match:
            ...
            if base64_data:
                ...
                print(f"   📤 Subiendo imagen principal a S3...")
                ...
                if s3_url:
                    ...
                    print(f"   ❌ Error al subir imagen principal")
            else:
                print(f"   ⚠️  No se encontró la imagen correspondiente en extracted_content")
