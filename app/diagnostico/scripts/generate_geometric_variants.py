...
def draw_square_figure(num_squares, output_path):
    ...
    if num_squares == 8:
        squares = [(0, 0), (1, 0), (2, 0), (3, 0), (0, 1), (1, 1), (0, 2), (1, 2)]
    elif num_squares == 10:  # Original-like
        squares = [(0, 0), (1, 0), (2, 0), (0, 1), (1, 1), (2, 1), (0, 2), (1, 2), (0, 3), (1, 3)]
    elif num_squares == 12:
        squares = [(0, 0), (1, 0), (2, 0), (3, 0), (0, 1), (1, 1), (2, 1), (3, 1), (1, 2), (2, 2), (1, 3), (2, 3)]
    else:
...
def draw_boxplot(stats, output_path, xlabel=""):
    ...
    # Datos para boxplot
    item = {"label": "", "whislo": stats[0], "q1": stats[1], "med": stats[2], "q3": stats[3], "whishi": stats[4], "fliers": []}
...
def draw_double_pie_q55(data1, data2, output_path):
    ...
    def bake_pie(ax, data, title):
        ...
        wedges, texts, autotexts = ax.pie(sizes, labels=labels, autopct="%1.0f %%", startangle=90, colors=colors, wedgeprops=dict(edgecolor="black"))
...
def draw_pie_q23(data, center_text, output_path):
    ...
    wedges, texts, autotexts = ax.pie(
        sizes, labels=labels, autopct="%1.0f%%", startangle=140, colors=colors, pctdistance=0.85, wedgeprops=dict(edgecolor="black")
    )
