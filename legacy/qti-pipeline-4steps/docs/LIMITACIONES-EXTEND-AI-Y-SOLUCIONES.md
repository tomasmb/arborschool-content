...
**Ubicación**: `app/qti-pipeline-4steps/pipeline/math_corrector.py`
...
**Para más detalles**: Ver `app/qti-pipeline-4steps/CORRECCION_MATEMATICA.md`
...
- `app/qti-pipeline-4steps/CORRECCION_MATEMATICA.md` - Documentación del MathCorrector
